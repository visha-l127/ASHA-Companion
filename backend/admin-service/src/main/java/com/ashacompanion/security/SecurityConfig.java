    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/users", "/users/**").hasAnyRole("ADMIN", "PHC_SUPERVISOR", "PHARMACIST")
                ...
                .requestMatchers("/admin-dashboard-stats", "/admin-dashboard-stats/**").hasRole("ADMIN")
                ...
                .requestMatchers(HttpMethod.GET, "/roles").hasAnyRole("ADMIN", "PHC_SUPERVISOR", "ASHA", "PHARMACIST")
                .requestMatchers(HttpMethod.PUT, "/settings").hasRole("ADMIN")
                .requestMatchers(HttpMethod.GET, "/settings").hasAnyRole("ADMIN", "PHC_SUPERVISOR", "ASHA", "PHARMACIST")
