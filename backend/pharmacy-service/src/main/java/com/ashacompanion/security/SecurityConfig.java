    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/medicines", "/medicines/**").hasAnyRole("ADMIN", "PHC_SUPERVISOR", "PHARMACIST", "ASHA")
                ...
                .requestMatchers(HttpMethod.POST, "/medicine-transactions/**").hasAnyRole("ADMIN", "PHARMACIST", "ASHA")
                .requestMatchers(HttpMethod.GET, "/medicine-transactions/**").hasAnyRole("ADMIN", "PHC_SUPERVISOR", "PHARMACIST", "ASHA")

                .requestMatchers(HttpMethod.GET, "/medicine-stock/**").hasAnyRole("ADMIN", "PHC_SUPERVISOR", "PHARMACIST", "ASHA")
